...
N 680 -520 680 -510 {lab=FDOTA_OUTP}
N 680 -370 680 -360 {lab=FDOTA_OUTN}
N 520 -340 520 -220 {lab=FDOTA_VCMFB}
N 520 -220 560 -220 {lab=FDOTA_VCMFB}
N 920 -440 920 -260 {lab=FDOTA_VOCM}
...
N 680 -450 680 -430 {lab=FDOTA_VOCM}
N 800 -370 800 -360 {lab=FDOTA_OUTN}
N 800 -520 800 -510 {lab=FDOTA_OUTP}
N 140 -200 160 -200 {lab=FDOTA_VOCM}
N 800 -450 800 -440 {lab=FDOTA_VOCM}
N 800 -440 800 -430 {lab=FDOTA_VOCM}
N 640 -480 660 -480 {lab=FDOTA_SS}
N 640 -400 660 -400 {lab=FDOTA_SS}
N 600 -360 800 -360 {lab=FDOTA_OUTN}
N 600 -520 800 -520 {lab=FDOTA_OUTP}
N 680 -440 920 -440 {lab=FDOTA_VOCM}
N 720 -260 920 -260 {lab=FDOTA_VOCM}
...
C {lab_wire.sym} 800 -520 0 1 {name=p21 sig_type=std_logic lab=FDOTA_OUTP}
C {lab_wire.sym} 800 -360 2 0 {name=p22 sig_type=std_logic lab=FDOTA_OUTN}
...
C {lab_wire.sym} 920 -440 0 1 {name=p32 sig_type=std_logic lab=FDOTA_VOCM}
...
C {ECG_Acquisition_IC/Design_Files/IC Design/Schematic/ANALOG_BLOCKS/FD_OTA/FDC/FDC.sym} 360 -300 0 0 {name=xFDC1}
C {ECG_Acquisition_IC/Design_Files/IC Design/Schematic/ANALOG_BLOCKS/FD_OTA/CMFB/CMFB.sym} 860 -60 0 1 {name=xCMFB1}
C {symbols/ppolyf_u_2k.sym} 680 -480 0 0 {name=R1
W=2e-6
L=100e-6
model=ppolyf_u_2k
spiceprefix=X
m=1}
C {symbols/ppolyf_u_2k.sym} 680 -400 0 0 {name=R2
W=2e-6
L=100e-6
model=ppolyf_u_2k
spiceprefix=X
m=1}
C {lab_wire.sym} 640 -480 0 0 {name=p34 sig_type=std_logic lab=FDOTA_SS}
C {lab_wire.sym} 640 -400 2 1 {name=p35 sig_type=std_logic lab=FDOTA_SS}
C {symbols/cap_mim_2f0fF.sym} 800 -480 0 0 {name=C1
W=5e-6
L=5e-6
model=cap_mim_2f0fF
spiceprefix=X
m=1}
C {symbols/cap_mim_2f0fF.sym} 800 -400 2 1 {name=C2
W=5e-6
L=5e-6
model=cap_mim_2f0fF
spiceprefix=X
