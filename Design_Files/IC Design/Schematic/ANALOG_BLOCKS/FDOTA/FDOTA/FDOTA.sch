...
C {ECG_Acquisition_IC/Design_Files/IC Design/Schematic/ANALOG_BLOCKS/FDOTA/FDC/FDC.sym} 360 -300 0 0 {name=xFDC1}
C {ECG_Acquisition_IC/Design_Files/IC Design/Schematic/ANALOG_BLOCKS/FDOTA/CMFB/CMFB.sym} 860 -60 0 1 {name=xCMFB1}
...
spiceprefix=X
m=1}
C {symbols/ppolyf_u_2k.sym} 680 -400 2 1 {name=R2
W=2e-6
L=100e-6
model=ppolyf_u_2k
spiceprefix=X
