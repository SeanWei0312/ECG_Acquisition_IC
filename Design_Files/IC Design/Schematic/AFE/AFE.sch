...
N 540 -680 540 -600 {lab=#net7}
N 580 -680 580 -600 {lab=#net8}
...
N 160 -680 400 -680 {lab=AGND}
N 120 -720 440 -720 {lab=AVDD}
N 120 -760 120 -320 {lab=AVDD}
N 160 -760 160 -280 {lab=AGND}
N 240 -440 240 -320 {lab=AVDD}
N 280 -440 280 -280 {lab=AGND}
N 1760 -1160 1780 -1160 {lab=INA_OUTP}
N 1760 -1120 1780 -1120 {lab=INA_OUTN}
N 1760 -1080 1780 -1080 {lab=INA_EXTP}
N 1760 -1040 1780 -1040 {lab=INA_EXTN}
N 2040 -1160 2060 -1160 {lab=LPF_OUTP}
N 2040 -1120 2060 -1120 {lab=LPF_OUTN}
N 2040 -1080 2060 -1080 {lab=LPF_EXTP}
N 2040 -1040 2060 -1040 {lab=LPF_EXTN}
N 2320 -1160 2340 -1160 {lab=PGA_OUTP}
...
N 1200 -920 1220 -920 {lab=SEON}
N 1200 -880 1220 -880 {lab=RLD}
N 1200 -1120 1220 -1120 {lab=INP}
N 1200 -1080 1220 -1080 {lab=INN}
N 1480 -1160 1500 -1160 {lab=BPINT}
N 1480 -1120 1500 -1120 {lab=BPEXT}
N 1480 -1080 1500 -1080 {lab=REFEXT}
N 1480 -1200 1500 -1200 {lab=BIAS_SEL}
N 1480 -1040 1500 -1040 {lab=BP}
N 1480 -1000 1500 -1000 {lab=REF}
N 1760 -1200 1780 -1200 {lab=INA_SEL}
N 2040 -1200 2060 -1200 {lab=LPF_SEL}
...
N 520 -920 520 -800 {lab=IB}
N 400 -920 400 -880 {lab=BIAS_SEL}
N 80 -540 480 -540 {lab=INP}
N 80 -480 200 -480 {lab=RLD}
N 80 -420 490 -420 {lab=INN}
N 880 -420 880 -200 {lab=INA_EXTN}
N 920 -460 920 -240 {lab=INA_EXTP}
N 760 -540 960 -540 {lab=INA_OUTP}
N 840 -500 960 -500 {lab=INA_OUTN}
N 760 -240 800 -240 {lab=INA_OUTP}
N 760 -200 840 -200 {lab=INA_OUTN}
N 880 -420 960 -420 {lab=INA_EXTN}
...
N 440 -840 480 -840 {lab=BP}
N 360 -240 400 -240 {lab=SEOP}
N 360 -200 440 -200 {lab=SEON}
N 440 -460 440 -200 {lab=SEON}
...
C {ECG_Acquisition_IC/Design_Files/IC Design/Schematic/LPF/LPF.sym} 1120 -320 0 0 {name=xLFP1}
C {ECG_Acquisition_IC/Design_Files/IC Design/Schematic/PGA/PGA.sym} 1820 -320 0 0 {name=xPGA1}
C {ECG_Acquisition_IC/Design_Files/IC Design/Schematic/SEL/SEL.sym} 900 -320 0 0 {name=xSEL1}
C {ECG_Acquisition_IC/Design_Files/IC Design/Schematic/INA/INA.sym} 420 -320 0 0 {name=xINA1}
C {ECG_Acquisition_IC/Design_Files/IC Design/Schematic/SEL/SEL.sym} 1600 -320 0 0 {name=xSEL2}
C {ECG_Acquisition_IC/Design_Files/IC Design/Schematic/SEL/SEL.sym} 2300 -320 0 0 {name=xSEL3}
C {ECG_Acquisition_IC/Design_Files/IC Design/Schematic/SEL/SEL.sym} 3000 -320 0 0 {name=xSEL4}
...
C {ECG_Acquisition_IC/Design_Files/IC Design/Schematic/RLD/RLD.sym} 440 -340 0 1 {name=xRLD1}
C {ECG_Acquisition_IC/Design_Files/IC Design/Schematic/BIAS/BIAS.sym} 40 -720 0 0 {name=xBIAS1}
...
C {lab_wire.sym} 400 -920 0 0 {name=p33 sig_type=std_logic lab=BIAS_SEL}
C {lab_wire.sym} 280 -920 0 0 {name=p36 sig_type=std_logic lab=BPEXT}
C {lab_wire.sym} 240 -920 0 0 {name=p53 sig_type=std_logic lab=BPINT}
C {lab_wire.sym} 80 -640 0 0 {name=p34 sig_type=std_logic lab=REF}
C {lab_wire.sym} 480 -920 0 0 {name=p35 sig_type=std_logic lab=BP}
C {ECG_Acquisition_IC/Design_Files/IC Design/Schematic/MIRROR/MIRROR.sym} 0 -600 0 0 {name=xMIRROR1}
C {opin.sym} 1760 -1160 0 1 {name=p102 lab=INA_OUTP}
C {opin.sym} 1760 -1120 0 1 {name=p103 lab=INA_OUTN}
C {lab_wire.sym} 1780 -1160 0 1 {name=p104 sig_type=std_logic lab=INA_OUTP}
C {lab_wire.sym} 1780 -1120 0 1 {name=p105 sig_type=std_logic lab=INA_OUTN}
C {ipin.sym} 1760 -1080 0 0 {name=p106 lab=INA_EXTP}
C {ipin.sym} 1760 -1040 0 0 {name=p107 lab=INA_EXTN}
C {lab_wire.sym} 1780 -1080 0 1 {name=p108 sig_type=std_logic lab=INA_EXTP}
C {lab_wire.sym} 1780 -1040 0 1 {name=p109 sig_type=std_logic lab=INA_EXTN}
C {opin.sym} 2040 -1160 0 1 {name=p110 lab=LPF_OUTP}
C {opin.sym} 2040 -1120 0 1 {name=p111 lab=LPF_OUTN}
C {lab_wire.sym} 2060 -1160 0 1 {name=p112 sig_type=std_logic lab=LPF_OUTP}
C {lab_wire.sym} 2060 -1120 0 1 {name=p113 sig_type=std_logic lab=LPF_OUTN}
C {ipin.sym} 2040 -1080 0 0 {name=p114 lab=LPF_EXTP}
C {ipin.sym} 2040 -1040 0 0 {name=p115 lab=LPF_EXTN}
C {lab_wire.sym} 2060 -1080 0 1 {name=p116 sig_type=std_logic lab=LPF_EXTP}
C {lab_wire.sym} 2060 -1040 0 1 {name=p117 sig_type=std_logic lab=LPF_EXTN}
C {opin.sym} 2320 -1160 0 1 {name=p118 lab=PGA_OUTP}
C {opin.sym} 2320 -1120 0 1 {name=p119 lab=PGA_OUTN}
C {lab_wire.sym} 2340 -1160 0 1 {name=p120 sig_type=std_logic lab=PGA_OUTP}
C {lab_wire.sym} 2340 -1120 0 1 {name=p121 sig_type=std_logic lab=PGA_OUTN}
C {ipin.sym} 2320 -1080 0 0 {name=p122 lab=PGA_EXTP}
...
C {lab_wire.sym} 1220 -1160 0 1 {name=p161 sig_type=std_logic lab=AGND}
C {opin.sym} 1200 -960 0 1 {name=p162 lab=SEOP}
C {opin.sym} 1200 -920 0 1 {name=p163 lab=SEON}
C {lab_wire.sym} 1220 -960 0 1 {name=p164 sig_type=std_logic lab=SEOP}
C {lab_wire.sym} 1220 -920 0 1 {name=p165 sig_type=std_logic lab=SEON}
C {opin.sym} 1200 -880 0 1 {name=p166 lab=RLD}
C {lab_wire.sym} 1220 -880 0 1 {name=p167 sig_type=std_logic lab=RLD}
C {ipin.sym} 1200 -1120 0 0 {name=p1 lab=INP}
C {ipin.sym} 1200 -1080 0 0 {name=p2 lab=INN}
C {lab_wire.sym} 1220 -1120 0 1 {name=p3 sig_type=std_logic lab=INP}
C {lab_wire.sym} 1220 -1080 0 1 {name=p4 sig_type=std_logic lab=INN}
C {opin.sym} 1480 -1160 0 1 {name=p5 lab=BPINT}
C {lab_wire.sym} 1500 -1160 0 1 {name=p9 sig_type=std_logic lab=BPINT}
C {ipin.sym} 1480 -1120 0 0 {name=p11 lab=BPEXT}
C {ipin.sym} 1480 -1080 0 0 {name=p12 lab=REFEXT}
C {lab_wire.sym} 1500 -1120 0 1 {name=p13 sig_type=std_logic lab=BPEXT}
C {lab_wire.sym} 1500 -1080 0 1 {name=p14 sig_type=std_logic lab=REFEXT}
C {ipin.sym} 1480 -1200 0 0 {name=p15 lab=BIAS_SEL}
C {lab_wire.sym} 1500 -1200 0 1 {name=p16 sig_type=std_logic lab=BIAS_SEL}
C {opin.sym} 1480 -1040 0 1 {name=p17 lab=BP}
C {opin.sym} 1480 -1000 0 1 {name=p18 lab=REF}
C {lab_wire.sym} 1500 -1040 0 1 {name=p19 sig_type=std_logic lab=BP}
C {lab_wire.sym} 1500 -1000 0 1 {name=p22 sig_type=std_logic lab=REF}
C {ipin.sym} 1760 -1200 0 0 {name=p23 lab=INA_SEL}
C {lab_wire.sym} 1780 -1200 0 1 {name=p24 sig_type=std_logic lab=INA_SEL}
C {ipin.sym} 2040 -1200 0 0 {name=p25 lab=LPF_SEL}
C {lab_wire.sym} 2060 -1200 0 1 {name=p26 sig_type=std_logic lab=LPF_SEL}
C {ipin.sym} 2320 -1200 0 0 {name=p27 lab=PGA_SEL}
C {lab_wire.sym} 2340 -1200 0 1 {name=p28 sig_type=std_logic lab=PGA_SEL}
C {ipin.sym} 2320 -1000 0 0 {name=p29 lab=S1}
...
C {lab_wire.sym} 1220 -1000 0 1 {name=p50 sig_type=std_logic lab=OUTN}
...
C {ECG_Acquisition_IC/Design_Files/IC Design/Schematic/SW/SW.sym} 240 -640 0 0 {name=xSW1}
C {ECG_Acquisition_IC/Design_Files/IC Design/Schematic/BUFFER/BUFFER.sym} 2520 -320 0 0 {name=xBUFFER1}
