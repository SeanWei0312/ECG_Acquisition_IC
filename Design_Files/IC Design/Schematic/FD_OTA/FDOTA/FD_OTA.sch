...
N 720 -440 760 -440 {lab=#net1}
N 720 -520 720 -510 {lab=FDOTA_OUTP}
N 720 -370 720 -360 {lab=FDOTA_OUTN}
N 520 -340 520 -220 {lab=#net2}
N 640 -480 720 -480 {lab=FDOTA_SS}
N 640 -400 720 -400 {lab=FDOTA_SS}
N 600 -520 720 -520 {lab=FDOTA_OUTP}
N 600 -360 720 -360 {lab=FDOTA_OUTN}
N 520 -220 560 -220 {lab=#net2}
N 850 -440 850 -260 {lab=#net1}
...
N 720 -260 850 -260 {lab=#net1}
N 760 -440 850 -440 {lab=#net1}
N 140 -280 160 -280 {lab=FDOTA_BCMFB}
N 140 -240 160 -240 {lab=FDOTA_REF}
N 760 -480 760 -400 {lab=#net1}
N 720 -450 720 -430 {lab=#net1}
...
C {ECG_Acquisition_IC/Design_Files/IC Design/Schematic/FD_OTA/FDC/FDC.sym} 360 -300 0 0 {name=xSEOTA1}
C {ECG_Acquisition_IC/Design_Files/IC Design/Schematic/FD_OTA/CMFB/CMFB.sym} 860 -50 0 1 {name=xSEOTA2}
C {symbols/nfet_03v3.sym} 740 -480 2 0 {name=M1
L=2u
W=1u
nf=1
m=1
...
C {symbols/nfet_03v3.sym} 740 -400 0 1 {name=M2
L=2u
W=1u
nf=1
m=1
...
C {lab_wire.sym} 640 -480 2 1 {name=p6 sig_type=std_logic lab=FDOTA_SS}
C {lab_wire.sym} 640 -400 0 0 {name=p7 sig_type=std_logic lab=FDOTA_SS}
