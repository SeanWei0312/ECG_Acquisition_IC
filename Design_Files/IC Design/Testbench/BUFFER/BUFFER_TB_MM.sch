...
N 560 -1220 560 -1200 {lab=BUFFER_SEL}
...
N 500 -1900 500 -1600 {lab=BUFFER_OUTP}
N 460 -1780 540 -1780 {lab=BUFFER_OUTN}
N 540 -1860 660 -1860 {lab=BUFFER_OUTN}
N 540 -1860 540 -1560 {lab=BUFFER_OUTN}
N 460 -1900 660 -1900 {lab=BUFFER_OUTP}
N 760 -1720 760 -1640 {lab=AGND}
N 720 -1720 720 -1680 {lab=AVDD}
N 800 -1720 800 -1600 {lab=BUFFER_SEL}
N 280 -1720 280 -1640 {lab=AGND}
N 240 -1720 240 -1680 {lab=AVDD}
N 460 -1600 500 -1600 {lab=BUFFER_OUTP}
N 460 -1560 540 -1560 {lab=BUFFER_OUTN}
N 620 -1820 660 -1820 {lab=BUFFER_EXTP}
N 620 -1820 620 -1600 {lab=BUFFER_EXTP}
N 620 -1600 660 -1600 {lab=BUFFER_EXTP}
N 580 -1560 660 -1560 {lab=BUFFER_EXTN}
N 580 -1780 580 -1560 {lab=BUFFER_EXTN}
N 580 -1780 660 -1780 {lab=BUFFER_EXTN}
...
.param BUFFER_GAIN_TARGET_SET=1
...
let buffer_diff=v(BUFFER_OUTP)-v(BUFFER_OUTN)

meas dc vos_meas when buffer_diff=0 cross=1
...
let buffer_out_cm=0.5*(v(BUFFER_OUTP)+v(BUFFER_OUTN))-v(AGND)
let out_cm_error=buffer_out_cm-v(REF)
...
let buffer_gain=mag(buffer_diff/vin_diff)

meas ac gain10 find buffer_gain at=10
meas ac gain150 find buffer_gain at=150

let norm_db=20*log10(buffer_gain/$&gain10)

meas ac bw3db when norm_db=-3 fall=1

meas ac ad60 find buffer_gain at=60
meas ac ad150 find buffer_gain at=150

let gain_error_pct=100*($&gain10/$&BUFFER_GAIN_TARGET_SET-1)
...
let acm=mag(buffer_diff/vin_cm)
...
C {lab_wire.sym} 560 -1220 0 0 {name=p10 sig_type=std_logic lab=BUFFER_SEL}
...
C {lab_wire.sym} 1840 -1360 0 0 {name=p38 sig_type=std_logic lab=BUFFER_EXTP}
...
C {lab_wire.sym} 1840 -1220 0 0 {name=p42 sig_type=std_logic lab=BUFFER_EXTN}
...
C {ECG_Acquisition_IC/Design_Files/IC Design/Schematic/SEL/SEL.sym} 600 -1680 0 0 {name=xSEL4}
...
C {lab_wire.sym} 660 -1600 0 1 {name=p132 sig_type=std_logic lab=BUFFER_EXTP}
C {lab_wire.sym} 660 -1560 0 1 {name=p133 sig_type=std_logic lab=BUFFER_EXTN}
C {ECG_Acquisition_IC/Design_Files/IC Design/Schematic/BUFFER/BUFFER.sym} 120 -1680 0 0 {name=xBUFFER1}
