...
let cl_ibias = 40e-6
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/SE_OTA/NOM.cl_op.txt cl_avdd cl_inp cl_out cl_b cl_idd cl_ibias
...
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/SE_OTA/NOM.cl_swing.txt sw_inp sw_out sw_idd

* Slew
alter @VP[PULSE] = [ 1.0 2.0 1u 1n 1n 10u 20u 0 ]

tran 1n 30u
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/SE_OTA/NOM.cl_slew.txt v(INP) v(OUT)
