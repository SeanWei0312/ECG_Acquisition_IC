...
let op_ibias = 40e-6
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/SE_OTA/FS.ol_op.txt op_avdd op_inp op_inn op_out op_b op_idd op_ibias

* Offset
dc VP $&off_lo $&off_hi $&off_step
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/SE_OTA/FS.ol_offset.txt v(INP) v(INN) v(OUT)
...
ac dec 200 1 1G
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/SE_OTA/FS.ol_ac_diff.txt db(v(OUT,AGND)) ph(v(OUT,AGND)) mag(v(OUT,AGND))
...
ac dec 200 1 1G
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/SE_OTA/FS.ol_ac_cm.txt db(v(OUT,AGND)) mag(v(OUT,AGND))
...
ac dec 200 1 1G
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/SE_OTA/FS.ol_ac_psrrp.txt db(v(OUT,AGND)) mag(v(OUT,AGND))
...
ac dec 200 1 1G
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/SE_OTA/FS.ol_ac_psrrn.txt db(v(OUT,AGND)) mag(v(OUT,AGND))
...
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/SE_OTA/FS.ol_noise_total.txt inoise_total onoise_total
