...
shell rm -f /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/ANALOG_BLOCKS/SE_OTA/\{$proc\}.Result_txt/\{$proc\}.ol_mc_summary.txt
shell rm -f /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/ANALOG_BLOCKS/SE_OTA/\{$proc\}.Result_txt/\{$proc\}.ol_mc_debug_op.txt


echo run vos_V center_error_V ol_gain_1Hz ol_gain_dB ugf_Hz phase_ugf_deg pm_deg vout_center_V b_V ibias_A idd_A power_W > /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/ANALOG_BLOCKS/SE_OTA/\{$proc\}.Result_txt/\{$proc\}.ol_mc_summary.txt

echo run vos_V vout_zero_V vout_center_V center_error_V net1_V net2_V net3_V net4_V b_V ibias_A idd_A power_W > /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/ANALOG_BLOCKS/SE_OTA/\{$proc\}.Result_txt/\{$proc\}.ol_mc_debug_op.txt
...
echo $runnum $vos_val $vout_zero_val $vout_center_val $center_error_val $net1_val $net2_val $net3_val $net4_val $b_val $ibias_val $idd_val $power_val >> /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/ANALOG_BLOCKS/SE_OTA/\{$proc\}.Result_txt/\{$proc\}.ol_mc_debug_op.txt
...
echo $runnum $vos_val $center_error_val $gain_val $gain_db_val $ugf_val $phase_val $pm_val $vout_center_val $b_val $ibias_val $idd_val $power_val >> /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/ANALOG_BLOCKS/SE_OTA/\{$proc\}.Result_txt/\{$proc\}.ol_mc_summary.txt
