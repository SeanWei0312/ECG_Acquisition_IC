...
shell rm -f /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/ANALOG_BLOCKS/FD_OTA/\{$proc\}.Result_txt/\{$proc\}.cl_mc_summary.txt
shell rm -f /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/ANALOG_BLOCKS/FD_OTA/\{$proc\}.Result_txt/\{$proc\}.cl_mc_debug_op.txt


echo run out_cm_error_V cl_gain_10 gain_error_pct ibias_fdc_A ibias_cmfb_A idd_A power_W > /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/ANALOG_BLOCKS/FD_OTA/\{$proc\}.Result_txt/\{$proc\}.cl_mc_summary.txt

echo run vin_diff_V vos_cl_V outp_V outn_V outcm_V outdiff_V ref_V vocm_V bfdc_V bcmfb_V ibias_fdc_A ibias_cmfb_A idd_A power_W > /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/ANALOG_BLOCKS/FD_OTA/\{$proc\}.Result_txt/\{$proc\}.cl_mc_debug_op.txt
...
save AVDD AGND INP INN OUTP OUTN REF VOCM BFDC BCMFB
save vavdd#branch
save @m.xmbfdc.m0[id]
...
echo $runnum $vin_diff_val $vos_cl_val $outp_val $outn_val $outcm_val $outdiff_val $ref_val $vocm_val $bfdc_val $bcmfb_val $ibias_fdc_val $ibias_cmfb_val $idd_val $power_val >> /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/ANALOG_BLOCKS/FD_OTA/\{$proc\}.Result_txt/\{$proc\}.cl_mc_debug_op.txt
...
echo $runnum $out_cm_error_val $cl_gain_val $gain_error_val $ibias_fdc_val $ibias_cmfb_val $idd_val $power_val >> /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/ANALOG_BLOCKS/FD_OTA/\{$proc\}.Result_txt/\{$proc\}.cl_mc_summary.txt
