...
shell rm -f /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/ANALOG_BLOCKS/FD_OTA/\{$proc\}.Result_txt/\{$proc\}.cl_*.txt
...
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/ANALOG_BLOCKS/FD_OTA/\{$proc\}.Result_txt/\{$proc\}.cl_\{$case\}_op.txt vdd vinp vinn vin_diff voutp voutn voutcm voutdiff vref vocm idd_total ibias_fdc ibias_cmfb
...
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/ANALOG_BLOCKS/FD_OTA/\{$proc\}.Result_txt/\{$proc\}.cl_\{$case\}_diff_dc.txt cl_vin_diff cl_voutp cl_voutn cl_voutcm cl_voutdiff cl_err cl_vocm cl_vref cl_idd cl_ibias_fdc cl_ibias_cmfb
...
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/ANALOG_BLOCKS/FD_OTA/\{$proc\}.Result_txt/\{$proc\}.cl_\{$case\}_icmr.txt icmr_cmd icmr_vin_diff icmr_voutp icmr_voutn icmr_voutcm icmr_voutdiff icmr_vocm icmr_vref icmr_idd icmr_ibias_fdc icmr_ibias_cmfb
...
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/ANALOG_BLOCKS/FD_OTA/\{$proc\}.Result_txt/\{$proc\}.cl_\{$case\}_diff_tran.txt tr_cmd tr_vin_diff tr_voutp tr_voutn tr_voutcm tr_voutdiff tr_err tr_vocm tr_vref tr_idd tr_ibias_fdc tr_ibias_cmfb
...
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/ANALOG_BLOCKS/FD_OTA/\{$proc\}.Result_txt/\{$proc\}.cl_\{$case\}_cm_tran.txt cm_vref cm_vrefbias cm_voutp cm_voutn cm_voutcm cm_voutdiff cm_vocm cm_err cm_idd cm_ibias_fdc cm_ibias_cmfb
...
C {ECG_Acquisition_IC/Design_Files/IC Design/Schematic/ANALOG_BLOCKS/FD_OTA/FDOTA/FD_OTA.sym} 700 -1120 0 0 {name=xFDOTA1}
