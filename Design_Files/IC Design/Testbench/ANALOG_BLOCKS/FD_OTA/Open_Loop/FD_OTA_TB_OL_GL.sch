...
shell rm -f /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/ANALOG_BLOCKS/FD_OTA/\{$proc\}.Result_txt/\{$proc\}.ol_mc_summary.txt
shell rm -f /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/ANALOG_BLOCKS/FD_OTA/\{$proc\}.Result_txt/\{$proc\}.ol_mc_debug_op.txt


echo run vos_V dc_gain_dB ugf_Hz phase_ugf_deg pm_deg > /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/ANALOG_BLOCKS/FD_OTA/\{$proc\}.Result_txt/\{$proc\}.ol_mc_summary.txt

echo run vos_V outp_zero_V outn_zero_V outdiff_zero_V outp_center_V outn_center_V outcm_center_V outdiff_center_V ref_V vocm_V > /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/ANALOG_BLOCKS/FD_OTA/\{$proc\}.Result_txt/\{$proc\}.ol_mc_debug_op.txt
...
echo $runnum $vos_val $outp_zero_val $outn_zero_val $outdiff_zero_val $outp_center_val $outn_center_val $outcm_center_val $outdiff_center_val $ref_val $vocm_val >> /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/ANALOG_BLOCKS/FD_OTA/\{$proc\}.Result_txt/\{$proc\}.ol_mc_debug_op.txt
...
echo $runnum $vos_val $gain_db_val $ugf_val $phase_val $pm_val >> /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/ANALOG_BLOCKS/FD_OTA/\{$proc\}.Result_txt/\{$proc\}.ol_mc_summary.txt
