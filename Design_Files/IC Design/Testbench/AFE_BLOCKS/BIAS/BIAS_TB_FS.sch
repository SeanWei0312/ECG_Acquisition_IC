...
shell mkdir -p /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FS.Result_txt

shell rm -f /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FS.Result_txt/FS.tran_nom.txt
shell rm -f /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FS.Result_txt/FS.tran_vl.txt
shell rm -f /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FS.Result_txt/FS.tran_vh.txt
shell rm -f /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FS.Result_txt/FS.tran_tl.txt
shell rm -f /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FS.Result_txt/FS.tran_th.txt
shell rm -f /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FS.Result_txt/FS.tran_tlvl.txt
shell rm -f /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FS.Result_txt/FS.tran_thvh.txt
shell rm -f /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FS.Result_txt/FS.dc2d.txt
...
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FS.Result_txt/FS.tran_nom.txt v(AVDD) v(SEL) v(BPINT) v(BP) v(BPEXT) v(VREFINT) v(VREF) v(VREFEXT) ibias irs imst vgs_mst vth_mst idd_bias_sel power_bias_sel
...
let idd_bias_sel = idd_total-ibias
let power_bias_sel = v(AVDD)*idd_bias_sel
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FS.Result_txt/FS.tran_vl.txt v(AVDD) v(SEL) v(BPINT) v(BP) v(BPEXT) v(VREFINT) v(VREF) v(VREFEXT) ibias irs imst vgs_mst vth_mst idd_bias_sel power_bias_sel
...
let idd_bias_sel = idd_total-ibias
let power_bias_sel = v(AVDD)*idd_bias_sel
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FS.Result_txt/FS.tran_vh.txt v(AVDD) v(SEL) v(BPINT) v(BP) v(BPEXT) v(VREFINT) v(VREF) v(VREFEXT) ibias irs imst vgs_mst vth_mst idd_bias_sel power_bias_sel
...
let idd_bias_sel = idd_total-ibias
let power_bias_sel = v(AVDD)*idd_bias_sel
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FS.Result_txt/FS.tran_tl.txt v(AVDD) v(SEL) v(BPINT) v(BP) v(BPEXT) v(VREFINT) v(VREF) v(VREFEXT) ibias irs imst vgs_mst vth_mst idd_bias_sel power_bias_sel
...
let idd_bias_sel = idd_total-ibias
let power_bias_sel = v(AVDD)*idd_bias_sel
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FS.Result_txt/FS.tran_th.txt v(AVDD) v(SEL) v(BPINT) v(BP) v(BPEXT) v(VREFINT) v(VREF) v(VREFEXT) ibias irs imst vgs_mst vth_mst idd_bias_sel power_bias_sel
...
let idd_bias_sel = idd_total-ibias
let power_bias_sel = v(AVDD)*idd_bias_sel
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FS.Result_txt/FS.tran_tlvl.txt v(AVDD) v(SEL) v(BPINT) v(BP) v(BPEXT) v(VREFINT) v(VREF) v(VREFEXT) ibias irs imst vgs_mst vth_mst idd_bias_sel power_bias_sel
...
let idd_bias_sel = idd_total-ibias
let power_bias_sel = v(AVDD)*idd_bias_sel
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FS.Result_txt/FS.tran_thvh.txt v(AVDD) v(SEL) v(BPINT) v(BP) v(BPEXT) v(VREFINT) v(VREF) v(VREFEXT) ibias irs imst vgs_mst vth_mst idd_bias_sel power_bias_sel
...
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FS.Result_txt/FS.dc2d.txt v(AVDD) v(BPINT) v(BP) v(VREFINT) v(VREF) ibias irs mirror_error vref_error imst mst_margin idd_bias_sel power_bias_sel
...
C {ECG_Acquisition_IC/Design_Files/IC Design/Schematic/AFE_BLOCKS/BIAS/BIAS.sym} 80 -1280 0 0 {name=xBIAS1}
...
C {ECG_Acquisition_IC/Design_Files/IC Design/Schematic/DIGITAL_BLOCKS/MUXD/MUXD.sym} 300 -1180 0 0 {name=xMUXD1}
