...
shell mkdir -p /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FF.Result_txt

shell rm -f /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FF.Result_txt/FF.tran_nom.txt
shell rm -f /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FF.Result_txt/FF.tran_vl.txt
shell rm -f /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FF.Result_txt/FF.tran_vh.txt
shell rm -f /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FF.Result_txt/FF.tran_tl.txt
shell rm -f /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FF.Result_txt/FF.tran_th.txt
shell rm -f /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FF.Result_txt/FF.tran_tlvl.txt
shell rm -f /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FF.Result_txt/FF.tran_thvh.txt
shell rm -f /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FF.Result_txt/FF.dc2d.txt
...
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FF.Result_txt/FF.tran_nom.txt v(AVDD) v(SEL) v(BPINT) v(BP) v(BPEXT) v(VREFINT) v(VREF) v(VREFEXT) ibias irs imst vgs_mst vth_mst idd_bias_sel power_bias_sel
...
let idd_bias_sel = idd_total-ibias
let power_bias_sel = v(AVDD)*idd_bias_sel
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FF.Result_txt/FF.tran_vl.txt v(AVDD) v(SEL) v(BPINT) v(BP) v(BPEXT) v(VREFINT) v(VREF) v(VREFEXT) ibias irs imst vgs_mst vth_mst idd_bias_sel power_bias_sel
...
let idd_bias_sel = idd_total-ibias
let power_bias_sel = v(AVDD)*idd_bias_sel
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FF.Result_txt/FF.tran_vh.txt v(AVDD) v(SEL) v(BPINT) v(BP) v(BPEXT) v(VREFINT) v(VREF) v(VREFEXT) ibias irs imst vgs_mst vth_mst idd_bias_sel power_bias_sel
...
let idd_bias_sel = idd_total-ibias
let power_bias_sel = v(AVDD)*idd_bias_sel
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FF.Result_txt/FF.tran_tl.txt v(AVDD) v(SEL) v(BPINT) v(BP) v(BPEXT) v(VREFINT) v(VREF) v(VREFEXT) ibias irs imst vgs_mst vth_mst idd_bias_sel power_bias_sel
...
let idd_bias_sel = idd_total-ibias
let power_bias_sel = v(AVDD)*idd_bias_sel
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FF.Result_txt/FF.tran_th.txt v(AVDD) v(SEL) v(BPINT) v(BP) v(BPEXT) v(VREFINT) v(VREF) v(VREFEXT) ibias irs imst vgs_mst vth_mst idd_bias_sel power_bias_sel
...
let idd_bias_sel = idd_total-ibias
let power_bias_sel = v(AVDD)*idd_bias_sel
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FF.Result_txt/FF.tran_tlvl.txt v(AVDD) v(SEL) v(BPINT) v(BP) v(BPEXT) v(VREFINT) v(VREF) v(VREFEXT) ibias irs imst vgs_mst vth_mst idd_bias_sel power_bias_sel
...
let idd_bias_sel = idd_total-ibias
let power_bias_sel = v(AVDD)*idd_bias_sel
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FF.Result_txt/FF.tran_thvh.txt v(AVDD) v(SEL) v(BPINT) v(BP) v(BPEXT) v(VREFINT) v(VREF) v(VREFEXT) ibias irs imst vgs_mst vth_mst idd_bias_sel power_bias_sel
...
wrdata /foss/designs/ECG_Acquisition_IC/Measurement_Results/IC_Simulation/AFE_BLOCKS/BIAS/FF.Result_txt/FF.dc2d.txt v(AVDD) v(BPINT) v(BP) v(VREFINT) v(VREF) ibias irs mirror_error vref_error imst mst_margin idd_bias_sel power_bias_sel
