...
| Week 22 | May 29 | **Tutorial Sessions** 🎓 | • Charlib (James)<br>• Full custom analog design flow (Vipul)<br> • ORFS Tutorial (Gaurav) <br>• gLayout [Tutorial 2 OTA]() (Anhang) | [Watch](https://us06web.zoom.us/rec/share/MLNBCb7vB8ggzrkPwc0yAslUJFi819PqMK6GzwiTdWhMRykd2PMECP5OVaj9fJtg.FKPz8puBRcpvN9k1) | [View](https://docs.google.com/presentation/d/e/2PACX-1vQTP6VWPEWemqOwfaWyAoGDvfKKkSd3Na3WMATTWCTAIPIPWx0YFB2lkzolOIVV8w/pub) | closed |
...
|------|--------|:-----------:|:--------:|:------:|
| TBD | Chips available for testing |  |  |  |  |
| TBD | Upload of Chip Test Results 👥 |  |  |  |  |

## 📋 Track Overview

The chipathon includes several parallel tracks:
- **A. Foundational building blocks**: Focused on basic analog and digital blocks.
- **B. Circuits for sensors**: Focused on circuits and systems enabling sensing, readout, and edge signal processing.
- **C. MOSbius playground for chips**: Focused on educational chips MOSbius style.
- **D. AI/LLM for circuits**: Focused on automated design flows (analog or digital) powered by AI.
...
- The go/no-go decision on (TBD) is a critical milestone for proceeding with manufacturing
...
- A. Foundational building blocks: James Stine, Saroj, Gaurav, Akhilesh Patil, Sumanth Kamineni
- B. Circuits for sensors: Camilo Velez, Vipul Sharma
- C. MOSbius playground for chips: Peter Kinget, Juan Moya Baquero, Luighi
- D. AI/LLM for circuits: Luighi, Mehdi Saligane, Saptarshi Ghosh, Gaurav, Osama Khan, Trio Adiono/Nur, Mauricio Montanares
- Tooling: Mitch, Harald, Leo, Saroj, Mehdi, Peter, Vipul, Herman, Luighi
- Integration: Juan M. Baquero
